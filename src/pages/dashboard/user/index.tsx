import {
  ...
  const Usuario: FC<UsuarioProps> = ({ allUsuario }) => {
    const [usuario, setUsuario] =
      useState<IUsuarioType[]>(allUsuario);
    ...
    const modalAdd = () =>
      openModal({
        ...
        radius: "md",
        children: (
          <AddUsuario onClose={closeAllModals} onSubmit={addUsuario} />
        ),
      });
    ...
    return (
      <div>
        ...
        <Header className={styles.header} bg="blue.6" height={80}>
          ...
          <Link className={styles.active} href={"/dashboard/user"}>Usuario</Link>
          <Link href={"/"}>Sair</Link>
        </Header>
